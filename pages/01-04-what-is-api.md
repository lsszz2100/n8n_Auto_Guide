...
자동화를 배우다 보면 반드시 만나는 단어가 있습니다. 바로 **API**입니다.
...
**API(Application Programming Interface)**는 두 개의 소프트웨어가 서로 대화할 수 있게 해주는 **규칙과 도구의 집합**입니다.
...
> **⚠️ 중요**: API 키는 절대 공개하면 안 됩니다. GitHub에 올리거나 다른 사람에게 공유하지 마세요!

---

## Webhook: 반대 방향의 API

일반 API는 우리가 먼저 요청을 보내는 방식이지만, **Webhook**은 다릅니다.

**Webhook**은 외부 서비스가 무언가 발생했을 때 **우리에게 먼저 알려주는** 방식입니다.
